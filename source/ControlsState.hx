    ...
    override function create() {
        ...
        for (i in 0...8) {
            var coolText = switch (i) {
				...
				case 4:
                    'Left-Alt: ${cast (FlxG.save.data.keys.leftAlt : String)}';
                case 5: 
				    'Down-Alt: ${cast (FlxG.save.data.keys.downAlt : String)}';
                case 6:
				    'Up-Alt: ${cast (FlxG.save.data.keys.upAlt : String)}';
                case 7:
				    'Right-Alt: ${cast (FlxG.save.data.keys.rightAlt : String)}';
                default:
                    'how did we get here';
            }
        ...
        if (!askingToBind) {
            ...
            if (FlxG.keys.firstJustPressed() != -1) {
                ...
                switch (awaitingFor) {
					...
					case 4:
                        FlxG.save.data.keys.leftAlt = FlxG.keys.firstJustPressed();
                    case 5:
                        FlxG.save.data.keys.downAlt = FlxG.keys.firstJustPressed();
                    case 6:
                        FlxG.save.data.keys.upAlt = FlxG.keys.firstJustPressed();
                    case 7:
                        FlxG.save.data.keys.rightAlt = FlxG.keys.firstJustPressed();
                }
