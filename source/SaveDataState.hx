...
class SaveDataState extends MusicBeatState
{
	...
	override function create()
	{
		...
		optionList = [
						//{name: "Window Size", value: false, intName: "windowSize", desc: "The size of your window", amount: cast WindowSize.Size.Normal, defAmount: cast WindowSize.Size.Normal, max: 4},
						...
						//{name: "Fullscreen", intName: "fullScreen", value: false, desc: "Makes the game fullscreen."},
						//{name: "Borderless Fullscreen", intName: "BfullScreen", value: false, desc: "Fullscreen but... uhh.. recording friendly?"}, 
						//{name: "Classic UI", value: false, intName: "classicUI", desc: "Just shows score instead of misses and all the crud."},
						//{name: "Ignore Unlocks", value: false, intName: "ignoreUnlocks", desc: "Show/Unlock all songs/weeks, even if you haven't met conditions."},
