...
class AnimationDebug extends FlxState
{
	...
	override function update(elapsed:Float)
	{
		...
		if (!bfText.hasFocus && !dadText.hasFocus) {
			...
			if (FlxG.keys.justPressed.ONE) {curAnim = 0; updateAnimation();}
			if (FlxG.keys.justPressed.TWO && 1 <= animList.length - 1) {curAnim = 1; updateAnimation();}
			if (FlxG.keys.justPressed.THREE && 2 <= animList.length - 1) {curAnim = 2; updateAnimation();}
			if (FlxG.keys.justPressed.FOUR && 3 <= animList.length - 1) {curAnim = 3; updateAnimation();}
			if (FlxG.keys.justPressed.FIVE && 4 <= animList.length - 1) {curAnim = 4; updateAnimation();}
			if (FlxG.keys.justPressed.SIX && 5 <= animList.length - 1) {curAnim = 5; updateAnimation();}
			if (FlxG.keys.justPressed.SEVEN && 6 <= animList.length - 1) {curAnim = 6; updateAnimation();}
			if (FlxG.keys.justPressed.EIGHT && 7 <= animList.length - 1) {curAnim = 7; updateAnimation();}
			if (FlxG.keys.justPressed.NINE && 8 <= animList.length - 1) {curAnim = 8; updateAnimation();}
			if (FlxG.keys.justPressed.ZERO && 9 <= animList.length - 1) {curAnim = 9; updateAnimation();}
			*/
