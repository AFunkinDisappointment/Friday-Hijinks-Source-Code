...
class Song
{
	...
	public static function loadFromJson(jsonInput:String, ?folder:String):SwagSong
	{
		...
		if (parsedJson.stageID == null) {
		    if (parsedJson.song.toLowerCase() == 'hijinks')
			    parsedJson.stageID = 2;
			else if (parsedJson.song.toLowerCase() == 'cloaked')
			    parsedJson.stageID = 1;
			else
