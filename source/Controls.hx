	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		switch (scheme)
		{
			...
			case Solo(false) | Solo(true):
				inline bindKeys(Control.UP, [FlxG.save.data.keys.up, FlxG.save.data.keys.upAlt]);
				inline bindKeys(Control.DOWN, [FlxG.save.data.keys.down, FlxG.save.data.keys.downAlt]);
				inline bindKeys(Control.LEFT, [FlxG.save.data.keys.left, FlxG.save.data.keys.leftAlt]);
				inline bindKeys(Control.RIGHT, [FlxG.save.data.keys.right, FlxG.save.data.keys.rightAlt]);
